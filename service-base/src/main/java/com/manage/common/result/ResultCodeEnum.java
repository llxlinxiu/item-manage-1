...
public enum ResultCodeEnum {
    ...
    ExpiredJwt_ERROR(false, 29001, "Token已过期"),
    UnsupportedJwt_ERROR(false, 29002, "Token格式错误"),
    MalformedJwt_ERROR(false, 29003, "Token没有被正确构造"),
    Signature_ERROR(false, 29004, "签名失败"),
    IllegalArgument_ERROR(false, 29005, "非法参数异常"),
